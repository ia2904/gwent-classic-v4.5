...
Some factions are based on the great work by [Novigrad Tavern](https://www.ebay.com/usr/novigrad_tavern). 
This remake is an attempt to implement the cards they designed (with some minor differences).
